...
export function useCredits() {
	...
	const [dailyBonusClaimed, setDailyBonusClaimed] = useState<boolean | null>(
		null,
	);
	const dailyBonusClaimedUserRef = useRef<string | null>(null);
	const springCampaignClaimedUserRef = useRef<string | null>(null);
	const [springCampaign, setSpringCampaign] =
		useState<SpringCampaignSnapshot | null>(null);
	...
	const claimSpringCampaign = useCallback(
		async (accessToken: string, userId: string): Promise<void> => {
